...
يقوم المثبّت نفسه أيضًا بتثبيت وتفعيل خدمة ZRAM على مستوى النظام. الحجم الافتراضي يساوي **50% من RAM الفعلية** بدون سقف 2GB؛ مثلًا 2GB RAM تعطي 1GB ZRAM و12GB RAM تعطي نحو 6GB. تستخدم الخدمة `zstd` عند دعمه ثم `lz4` كخيار تالٍ، وتمنح ZRAM أولوية swap أعلى من ملف swap القرصي. إذا كان ZRAM قديمًا ومستخدمًا وقت الترقية فلن تُجبر الصفحات على العودة للذاكرة؛ يؤجَّل تغيير الحجم بأمان حتى إعادة التشغيل التالية.
