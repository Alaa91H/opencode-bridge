...
class WorkspaceManagerTests(unittest.TestCase):
    ...
    def test_normalize_slug_accepts_common_github_forms(self) -> None:
        ...
        self.assertEqual(self.manager.normalize_slug("https://github.com/Alaa91H/opencode-bridge.git"), "Alaa91H/opencode-bridge")
        self.assertEqual(self.manager.normalize_slug("git@github.com:Alaa91H/opencode-bridge.git"), "Alaa91H/opencode-bridge")
    ...
    def test_allowlist_is_case_insensitive(self) -> None:
        self.assertEqual(self.manager.require_allowed("alaa91h/OPENCODE-BRIDGE"), "alaa91h/OPENCODE-BRIDGE")
