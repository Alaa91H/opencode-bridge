...
المرفقات: فيك تبعت صورة، مستند، فيديو، صوت، ملصق أو ملف تيليغرام عادي مع شرح اختياري. البوت يمرّره للوكيل ويرسل الملفات التي ينشئها ضمن نتيجة المهمة. تُحفظ مرفقات البوت لمدة 7 أيام فقط.

أثناء التنفيذ، البوت بيحدّث رسالة تقدم واحدة ويعرض مراحل التشغيل والأدوات والحالة. ما بيعرض النص الداخلي الخام أو مخرجات الأوامر الحساسة؛ استخدم زر «تحديث التقدم» أو /progress و/trace لمراجعة النشاط.

أوامر البناء والتجميع على الخادم محظورة لحماية الاستقرار؛ حضّر الملفات خارج الخادم ثم أرسل الناتج الجاهز."""
